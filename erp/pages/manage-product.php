...
<span class="required"> * </span>
                            ...
                            <div class="modal-footer">
                                ...
                                <button id="edit_save" name="edit_product" type="submit" class="btn btn-primary">Save changes</button>
                            </div>
...
//         if(isset($_SESSION['status']) && $_SESSION['status'] == PRODUCT_EDIT_SUCCESS){
      ?>
<!--        <script>toastr["success"]("You successfully changed", "Product Edit")</script>-->
      <?php
