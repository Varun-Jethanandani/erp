...
<?php
    if(isset($_GET['q']))
    {
        if($_GET['q'] == 'success'){
            ...
            <button class='close' data-close='alert'></button> Phone Number of the entered supplier already exists in supplier!</div>";
    }
    }
                                        ?>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Supplier Email <span class="required"> * </span></label>
                                            <div class="col-md-4">
