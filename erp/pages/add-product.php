...
<span class="required"> * </span>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    ...
                                                                    <!--Here value is made 0 therefore placeholder "EOQ" is not displayed  -->
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <!--we have used the blank option below to ignore the extra first placeholder which automatically selects option 1  -->
                            <option></option>
                            <?php 
...
<!--                                                                here accept is with image/* which is used to upload images of all extensions-->
                                                                  </span>
