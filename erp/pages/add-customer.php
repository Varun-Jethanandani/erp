...
<?php
    if(isset($_GET['q']))
    {
        if($_GET['q'] == 'success'){
            ...
            <button class='close' data-close='alert'></button> Phone Number of the entered customer already exists in customer!</div>";
    }
    }
                                        ?>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Customer Email <span class="required"> * </span></label>
                                            <div class="col-md-4">
